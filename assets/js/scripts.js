...
$(window).on('load', function() { // makes sure the whole site is loaded 
	"use strict";
	$('#status').delay(1900).fadeOut(); // will first fade out the loading animation 
	$('#preloader').delay(1900).fadeOut('slow'); // will fade out the white DIV that covers the website. 
...
(function($) {
	...
	/* Initialize YTPlayer for header video background */
	$(".player").mb_YTPlayer();
